...
namespace Names
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Random r = new Random();
            string randomFemaleName = GetRandomString(femaleFirstNames, r);
            string randomMaleName = GetRandomString(maleFirstNames, r);
            string randomMaleSurname = GetRandomString(maleSurnamesSk, r);
            string randomFemaleSurname = GetRandomString(femaleSurnamesSk, r);

            Console.WriteLine("Random male name: " + randomMaleName + " " + randomMaleSurname);
            Console.WriteLine("Random female name: " + randomFemaleName + " " + randomFemaleSurname);
        }
